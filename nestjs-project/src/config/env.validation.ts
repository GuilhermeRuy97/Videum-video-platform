...
export const envValidationSchema = Joi.object({
  ...
  STORAGE_PART_SIZE_BYTES: Joi.number().default(104857600),
  STORAGE_PRESIGN_EXPIRY_SECONDS: Joi.number().default(3600),
  REDIS_HOST: Joi.string().default('redis'),
  REDIS_PORT: Joi.number().default(6379),
  RECONCILIATION_INTERVAL_MS: Joi.number().default(300000),
  ABANDONED_UPLOAD_TIMEOUT_MS: Joi.number().default(3600000),
});
