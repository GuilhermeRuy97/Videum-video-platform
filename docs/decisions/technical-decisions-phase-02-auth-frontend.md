...
**Capability:** Transversal — covers: "User signup with email and password", "User login and session control", "Logout", "Signup, login, account confirmation and password recovery screens"
...
**Capability:** Signup, login, account confirmation and password recovery screens
...
**Capability:** Transversal — covers: "User signup with email and password", "User login and session control", "Logout", "Password recovery: request via email → link with token → reset"
