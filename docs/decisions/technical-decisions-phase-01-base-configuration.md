...
**Capability:** Next.js project (frontend) (will be created later, not now) and Nest.js (backend) initialized
...
**Capability:** Transversal — covers: "Next.js project (frontend) (will be created later, not now) and Nest.js (backend) initialized", "Local development environment with all services via Docker Compose"
