...
# Technical Decisions — Phase 02: Signup, Login and Account Management
...
- `next-frontend/` — Frontend deferred: registration, login, confirmation and password-recovery screens (`Signup, login, account confirmation and password recovery screens`) will be addressed in a future phase when `next-frontend/` is initialized. No open decision in this document.
...
**Capability:** User signup with email and password
...
**Capability:** User login and session control
...
**Capability:** Transversal — covers: "Account confirmation via email with activation link", "Password recovery: request via email → link with token → reset"
...
**Capability:** Transversal — covers: "User signup with email and password", "User login and session control", "Password recovery: request via email → link with token → reset"
