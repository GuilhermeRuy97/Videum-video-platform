...
test.describe("auth-login", () => {
  ...
  test("1.1 login-success-session-started", async ({ page }) => {
  ...
  test("1.2 login-errors-401-403-400", async ({ page }) => {
    await page.goto("/login")
    ...
    await expect(
      page.getByRole("link", { name: /Resend confirmation email/i })
    ).toBeVisible()
  ...
  test("1.3 login-client-side-validation-blocks-submit", async ({ page }) => {
    await page.goto("/login")
