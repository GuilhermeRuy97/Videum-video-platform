...
function ForgotPasswordForm({
  ...
  async function onSubmit(values: ForgotPasswordValues) {
    ...
    // 204 — identical response whether or not the email is registered
  ...
  if (sent) {
    return (
      ...
      >
        <p className="text-label-lg text-foreground">Check your email</p>
        <p className="text-body-md text-muted-foreground">
          If there is an account associated with this address, we sent a link to
          reset your password.
        </p>
      </div>
    )
