...
|--------|-------|------|------------|-------------------|
| Signup screen | /signup | Create user account | "Users can register" | SignupForm |
| Upload screen | /upload | Trigger new video upload | "Users can upload videos" | UploadButton |

### Server-connected Components

- `SignupForm` (Signup screen) — `Reuse?: new`
- `UploadButton` (Upload screen) — `Reuse?: components/ui/upload-button`
